      ...
      <div className="container">
        <div className="cta-box reveal-scale">
          ...
          <div className="cta-actions">
            ...
            <ShinyButton href="https://drive.google.com/file/d/1C_7fz0QNnb3oER9fRUl1ipem7OY5q0rA/view?usp=sharing" target="_blank" rel="noopener noreferrer" outline>Download Resume ↓</ShinyButton>
          </div>
        </div>
      </div>
    </section>
